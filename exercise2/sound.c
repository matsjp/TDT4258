...
uint16_t sound1[4] = { 0x22, 0x22, 0xf2, 0xd2 };
uint16_t sound2[5] = { 0x62, 0x32, 0x22, 0xf2, 0xd2 };
uint16_t sound3[6] = { 0x22, 0xf2, 0xd2, 0x22, 0xf2, 0xd2 };
uint16_t sound4[7] = { 0x22, 0xf2, 0xd2, 0x82, 0x22, 0xf2, 0xd2 };
